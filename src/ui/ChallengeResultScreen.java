...
public class ChallengeResultScreen {
	...
	private void initialize() {
		...
		panel_Team.setBounds(62, 122, 244, 272);
		...
		lblTeamTitle.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblTeamTitle.setBounds(62, 11, 109, 26);
		panel_Team.add(lblTeamTitle);
		
		JLabel lblMonster1Health = new JLabel("<name> current health : <healthLevel>");
		lblMonster1Health.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblMonster1Health.setBounds(10, 45, 224, 26);
		panel_Team.add(lblMonster1Health);
		
		JLabel lblMonster2Health = new JLabel("<name> current health : <healthLevel>");
		lblMonster2Health.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblMonster2Health.setBounds(10, 105, 224, 26);
		panel_Team.add(lblMonster2Health);
		
		JLabel lblMonster3Health = new JLabel("<name> current health : <healthLevel>");
		lblMonster3Health.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblMonster3Health.setBounds(10, 164, 224, 26);
		panel_Team.add(lblMonster3Health);
		
		JLabel lblMonster4Health = new JLabel("<name> current health : <healthLevel>");
		lblMonster4Health.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblMonster4Health.setBounds(10, 223, 224, 26);
		...
		lblBossTitle.setFont(new Font("Tahoma", Font.PLAIN, 15));
